...
export default function PromptPage() {
  ...
  useEffect(() => {
    ;(async () => {
      try {
        const res = await axios.get("https://hackathonbackend-2-g2dz.onrender.com/health", { timeout: 3000 })
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (uploadedFile) {
        ...
        res = await axios.post("https://hackathonbackend-2-g2dz.onrender.com/forecast-excel", formData, {
          headers: {
        ...
        // Handle text prompt
        res = await axios.post("https://hackathonbackend-2-g2dz.onrender.com/forecast", { query: prompt })
      }
